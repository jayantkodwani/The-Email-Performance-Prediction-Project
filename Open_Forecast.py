...
email['Sent'] = pd.to_numeric(email['Sent'].str.replace(",", ""), errors='coerce')
print (email.head())

X = email[['Sent','Play Num','Solution Area Num']]
y = email['Opens'].apply(lambda x: float(x))
